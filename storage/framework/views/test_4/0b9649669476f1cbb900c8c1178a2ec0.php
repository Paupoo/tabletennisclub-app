...
<?php $component = Mary\View\Components\Button::resolve(['icon' => 'o-x-mark','tooltip' => __('Clear selection')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-ghost btn-sm btn-square ml-auto','wire:click' => '$set(\'selected\', [])']); ?>
...
<?php /**PATH /home/aurelien/Documents/01 Projets/03-tabletennisclub-app/resources/views/components/admin/shared/bulk-bar.blade.php ENDPATH**/ ?>