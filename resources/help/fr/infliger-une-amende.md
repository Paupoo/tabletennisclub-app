...
Deux chemins, le second est plus sûr :

- **Trésorerie → Amendes**, puis choisissez le membre dans le formulaire.
- **Depuis la liste des membres**, sur la ligne de la personne — le formulaire s'ouvre **avec le membre déjà rempli**. Un risque d'erreur en moins.

Il vous faut ensuite :

- **Le motif** : forfait, absence injustifiée, retard, comportement, ou autre.
- **Le montant**, en euros. Au moins 0,01 €.
- **Le message au membre** — obligatoire, minimum 10 caractères.
- **La référence fédérale** et une **description** : facultatives, mais c'est ce qui vous permettra de retrouver l'origine dans six mois. Remplissez-les.

## Le message n'est pas une formalité

Un texte pré-rempli vous est proposé, avec un aperçu en direct. **Réécrivez-le** : il part **tel quel** au membre, votre texte est le seul qu'il lira.

C'est le point du dispositif. Le membre voit ce message déplié à côté de l'amende dans son espace — l'objectif est qu'il **comprenne** pourquoi il paie, pas seulement qu'il paie. Un message expédié produit un membre qui râle ; un message qui explique produit un membre qui ne recommence pas.
