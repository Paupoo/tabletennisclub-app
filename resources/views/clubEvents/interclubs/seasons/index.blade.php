        ...
        <x-admin-block>
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start space-y-3 sm:space-y-0">
                    <div>
                        ...
                        <p class="text-gray-600 text-xs sm:text-sm lg:text-base">
                            {{ __('Manage club seasons and member subscriptions.') }}
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col xs:flex-row space-y-2 xs:space-y-0 xs:space-x-2 lg:space-x-3">
                        ...
                        <a href="{{ route('clubEvents.interclubs.seasons.create') }}"
            ...
            <div x-show="showStats" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4">
                    <div
                        ...
                        <div class="text-base sm:text-xl lg:text-2xl font-bold text-club-yellow">{{ $seasons->count() }}
                        </div>
                    ...
                    <div class="bg-club-yellow rounded-lg p-2 sm:p-4 text-center border border-club-yellow">
                        <div class="text-base sm:text-xl lg:text-2xl font-bold text-club-blue">
                            {{ $seasons->sum(fn($s) => $s->users()->count()) }}
                        </div>
                        <div class="text-xs sm:text-sm text-club-blue font-medium">{{ __('Total Subscriptions') }}
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div class="text-center py-8 sm:py-12 px-4">
                    ...
                    <h3 class="text-base sm:text-lg font-medium text-gray-900 mb-2">{{ __('No seasons found') }}
                    </h3>
                    <p class="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
                        {{ __('Start by creating your first season to manage subscriptions.') }}
                    </p>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <span
                                                class="text-sm font-medium text-gray-900">{{ $season->users()->count() }}</span>
                                            <span
                                                class="text-xs text-gray-500 ml-1">{{ __('members') }}</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <button
                                            @click="selectedSeason = {{ $season->id }}; showSubscribeModal = true"
                                        ...
                                        <a href="{{ route('clubEvents.interclubs.seasons.show', $season) }}"
                                        ...
                                        @can('update', $season)
                                        <a href="{{ route('clubEvents.interclubs.seasons.edit', $season) }}"
                                        ...
                                        @can('delete', $season)
                                        <form action="{{ route('clubEvents.interclubs.seasons.destroy', $season) }}"
                    ...
                    <div class="border-b border-gray-200 last:border-b-0">
                        <div class="p-4 space-y-3">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                ...
                                @if ($season->end_at >= now())
                                <span
                                    class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 flex-shrink-0">
                                    {{ __('Active') }}
                                </span>
                                @else
                                <span
                                    class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600 flex-shrink-0">
                                    {{ __('Finished') }}
                                </span>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center gap-4 text-xs text-gray-500">
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="whitespace-nowrap">{{ $season->start_at->format('d/m/y') }} -
                                        {{ $season->end_at->format('d/m/y') }}</span>
                                </div>
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        class="font-medium text-gray-900">{{ $season->users()->count() }}</span>
                ...
                <div x-show="showSubscribeModal" @click.outside="showSubscribeModal = false"
                    ...
                    <form action="" method="POST" class="space-y-4" x-ref="subscribeForm">
                        ...
                        <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 pt-4">
                            ...
                            <button type="button"
                                @click="
                                        $refs.subscribeForm.action = '{{ route('clubEvents.interclubs.seasons.index') }}/' + selectedSeason + '/subscribe';
