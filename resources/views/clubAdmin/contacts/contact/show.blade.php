                                    ...
                                    <div class="flex items-start space-x-3">
                                        <div
                                            ...
                                            <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor"
                                                 viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                      d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-1.586z"></path>
                                            </svg>
                                        </div>
    ...
    <x-modal name="confirm-delete-contact" focusable>
        <div class="p-6" x-data="{ confirmText: '', isValid() { return this.confirmText === 'DELETE' } }">
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                ...
                <form action="{{ route('clubAdmin.contacts.destroy', $contact) }}" method="POST" class="flex-1">
                    @csrf
                    @method('DELETE')
                    <button
                        type="submit"
