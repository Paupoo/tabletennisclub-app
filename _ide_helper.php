...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Determine if the application eventPosts are cached.
         *
         * @return bool
         * @static
         */
        ...
        /**
         * Get the path to the eventPosts cache file.
         *
         * @return string
         * @static
         */
    ...
    class Artisan {
        /**
         * Re-route the Symfony command eventPosts to their Laravel counterparts.
         *
         * @internal
    ...
    class Event {
        ...
        /**
         * Flush a set of pushed eventPosts.
         *
         * @param string $event
         * @return void
         * @static
        ...
        /**
         * Specify the eventPosts that should be dispatched instead of faked.
         *
        ...
        /**
         * Assert that no eventPosts were dispatched.
         *
         * @return void
         * @static
         */
        ...
        /**
         * Get all of the eventPosts matching a truth-test callback.
         *
         * @param string $event
         * @param callable|null $callback
         * @return \Illuminate\Support\Collection
        ...
        /**
         * Get the eventPosts that have been dispatched.
         *
         * @return array
         * @static
         */
    ...
    class Log {
        ...
        /**
         * Normal but significant eventPosts.
         *
         * @param string|\Stringable $message
         * @param array $context
         * @return void
    ...
    class Schedule {
        ...
        /**
         * Get all of the eventPosts on the schedule that are due.
         *
         * @param \Illuminate\Contracts\Foundation\Application $app
         * @return \Illuminate\Support\Collection
         * @static
        ...
        /**
         * Get all of the eventPosts on the schedule.
         *
         * @return \Illuminate\Console\Scheduling\Event[]
         * @static
         */
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
        ...
        /**
         * Save a new model and return the instance without raising model eventPosts.
         *
         * @param array $attributes
         * @return TModel
         * @static
        ...
        /**
         * Save a new model instance with mass assignment without raising model eventPosts.
         *
         * @param array $attributes
         * @return TModel
         * @static
