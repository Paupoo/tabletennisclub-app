 ...
 *
 * @method static \Database\Factories\ClubEvents\Tournament\PoolFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\Database\Factories\ClubEvents\Tournament\PoolFactory> */
    use HasFactory;
