<nav class="{{ $fixed ?? true ? 'fixed' : '' }} w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xs z-50 shadow-xs" x-data="navigation">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    <a href="{{ route('home') }}" class="text-gray-900 dark:text-white hover:text-club-blue px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('home') ? 'text-club-blue' : '' }}">
                        Accueil
                    </a>
