...
new class extends Component
{
     ...
     * rights, or for both.
     *
     * Everyone on this list may read the file (`users.view` opens both); this
     * decides whether the row's action is "Edit" or "View". It asks for either
     * half rather than `update` alone: an access manager holds no
     * `users.update`, and still edits the rights half.
     */
