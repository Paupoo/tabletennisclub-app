<section id="join" class="h-auto flex items-center py-20 bg-base-100">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            <h2 class="text-4xl font-bold text-base-content mb-4">{{ __('Ready to join us?') }}</h2>
        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-base-100 rounded-2xl shadow-lg border-2 border-primary p-8 animate-on-scroll">
                <div class="text-center mb-6">
                    ...
                    <h3 class="text-2xl font-bold text-base-content mb-2">Affiliations</h3>
                    <p class="text-muted mb-4">{{ __('Minimum - Recreational licence') }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-lg mx-auto">
                        ...
                        <div
                            ...
                            <div class="text-3xl font-bold text-primary mb-1">60€</div>
                            <p class="text-xs text-muted">Par an et par personne</p>
                        </div>
                        <!-- Licence Compétitive -->
                        <div
                            class="bg-info/10 border-2 border-info/40 rounded-xl p-4 hover:shadow-md transition-shadow">
                            <div class="font-semibold text-base-content mb-1">
                                Licence Compétitive
                            </div>
                            <div class="text-3xl font-bold text-primary mb-1">125€</div>
                            <p class="text-xs text-muted">Par an et par personne</p>
                        </div>
            ...
            <div class="bg-base-100 rounded-2xl shadow-lg border-2 border-club-yellow p-8 animate-on-scroll">
                <div class="text-center mb-6">
                    <div class="w-16 h-16 bg-club-yellow rounded-full flex items-center justify-center mx-auto mb-4">
                        {{-- Aplat jaune plein : l'encre ne peut pas suivre `primary`, qui devient jaune
                        elle aussi en mode sombre. --}}
                        <x-icon name="o-bolt" class="w-8 h-8 text-club-blue" />
                    </div>
                    <h3 class="text-2xl font-bold text-base-content mb-2">{{ __('Directed Training') }}</h3>
                    <p class="text-muted mb-4">{{ __('Optional - With qualified coach') }}</p>
                </div>
                ...
                <div class="space-y-4 mb-6">
                    <div class="bg-base-200 rounded-lg p-4">
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-2xl font-bold text-primary">90€</span>
                        </div>
                        <p class="text-sm text-muted">{{ __('Per year - 1 session/week') }}</p>
                    </div>
                    ...
                    <div class="bg-club-yellow/10 rounded-lg p-4 border border-club-yellow">
                        ...
                        <p class="text-sm text-muted">{{ __('Per year - 10€ discount') }}</p>
        ...
        <div class="bg-base-100 rounded-2xl shadow-lg p-8 animate-on-scroll" x-data="priceCalculator">
            <h3 class="text-2xl font-bold text-base-content mb-6 text-center">Calculez Votre Cotisation</h3>

            <div class="grid md:grid-cols-2 gap-8">
                <div class="space-y-6">
                    <!-- Nombre de membres -->
                    <div>
                        <label class="block text-sm font-medium text-muted mb-2">Nombre de membres de la
                            famille</label>
        ...
        <div class="mt-12 bg-info/10 rounded-lg p-6 animate-on-scroll">
            <div class="flex items-start">
                <div class="shrink-0">
                    <x-icon name="o-information-circle" class="w-6 h-6 text-primary mt-1" />
                </div>
                <div class="ml-3">
                    <h4 class="text-lg font-semibold text-base-content mb-2">Informations importantes</h4>
