        ...
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
            <div
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <label
                            class="text-sm font-medium text-gray-700 whitespace-nowrap">{{ __('Visibility') }}</label>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th wire:click="sortBy('is_public')"
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                                <div class="flex items-center space-x-1">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($articles as $article)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $article->user->first_name }}
                                        {{ $article->user->last_name }}</div>
                                    <div class="text-sm text-gray-500">{{ $article->user->email }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $article->created_at->format('d/m/Y') }}
                                    <div class="text-xs text-gray-400">
                                        {{ $article->created_at->timezone('Europe/Brussels')->format('H:i') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $statusConfig = [
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        @can('delete', Auth()->user())
                                            <button wire:click="$set('selectedArticleId', {{ $article->id }})"
        ...
        <x-modal name="confirm-delete-article" focusable>
            <div class="p-6">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                    ...
                    <x-danger-button wire:click="deleteArticle()" @click="$dispatch('close')" class="flex-1">
