...
/**
 * The club's own charter — the single source for both the page members read and
 * the modal they sign in.
 *
 * The committee owns this text: it is the club's own agreement, not a federation
 * document, so it is kept here rather than fetched from the AFTTB.
 */
class ClubCharter
{
    /**
     * Bumped by hand when the committee changes the substance of the charter,
