        ...
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4 space-y-4 sm:space-y-0">
                <div class="flex-1">
                    ...
                    <div class="space-y-1">
                        <p class="text-sm sm:text-base text-gray-600">
                            <span class="font-medium">Auteur:</span> {{ $article->user->first_name }}
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    @if ($article->is_public)
                        <span
                            class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs sm:text-sm font-medium inline-flex items-center">
                    ...
                    @else
                        <span
                            class="bg-gray-100 text-gray-800 px-3 py-1 rounded-full text-xs sm:text-sm font-medium inline-flex items-center">
                            <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                ...
                @if ($article->is_public && $article->status->value === 'published')
                    <a href="{{ route('public.articles.show', $article) }}" target="_blank"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border-b border-gray-100 pb-2">
                            ...
                            <p class="text-sm sm:text-base text-gray-800 mt-1">
                                {{ $article->is_public ? 'Public' : 'Privé' }}</p>
                        </div>

                        <div class="border-b border-gray-100 pb-2">
                            <span class="text-xs sm:text-sm font-medium text-gray-500">Nombre de caractères</span>
                            <p class="text-sm sm:text-base text-gray-800 mt-1">{{ strlen($article->content) }}
                                caractères</p>
                        </div>
                        ...
                        <div class="border-b border-gray-100 pb-2">
                            ...
                            <p class="text-sm sm:text-base text-gray-800 mt-1">
                                {{ str_word_count(strip_tags($article->content)) }} mots</p>
                        </div>
                    </div>
                </div>
                        ...
                        @if ($article->updated_at && $article->updated_at != $article->created_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $article->updated_at->format('d/m/Y à H:i') }}
                                    </p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if ($article->deleted_at)
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $article->deleted_at->format('d/m/Y à H:i') }}
                                    </p>
                                </div>
                            </div>
                        @endif
