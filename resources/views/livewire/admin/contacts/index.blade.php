            ...
            <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0 lg:space-x-4">
                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select wire:model.live="status" class="border border-gray-300 pr-8 rounded-lg px-3 py-2 text-sm focus:ring-club-blue focus:border-club-blue">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select wire:model.live="interest" class="border border-gray-300 rounded-lg px-3 pr-8 py-2 text-sm focus:ring-club-blue focus:border-club-blue">
                            <option value="">{{ __('All') }}</option>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th wire:click="sortBy('interest')" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100">
                                <div class="flex items-center space-x-1">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($contacts as $contact)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $contact->interest?->getLabel() ?? 'Non spécifié' }}</div>
                                </td>
