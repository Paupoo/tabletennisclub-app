                    ...
                    <form action="{{ route('roles.update', $role->id) }}" method="POST" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="block w-full mt-1"
                                :value="old('name', $role->name)" required autofocus autocomplete="name"></x-text-input>
                        ...
                        <div>
                            ...
                            <x-textarea-input id="description" name="description" type="text" class="block w-full mt-1"
                                autofocus autocomplete="description">{{ old('description', $role->description) }}</x-textarea-input>
