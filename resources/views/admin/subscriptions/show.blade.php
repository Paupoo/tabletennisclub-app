        ...
        <x-admin-block>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    @if ($subscription->payments->count() > 0 && $subscription->status == 'confirmed')
                        <form method="POST" action="{{ route('admin.subscriptions.sendPaymentInvite') }}"
                            class="inline">
                            @csrf
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                {{ __('Mark this subscription as deleted (can be restored)') }}</p>
                        </div>
                        <form method="POST" action="{{ route('admin.subscriptions.unsubscribe', $subscription) }}"
                            class="inline">
                            @csrf
                    ...
                    <div class="flex items-center justify-between p-4 border border-red-200 rounded-lg bg-red-50">
                        <div>
                            ...
                            <p class="text-xs text-red-600">
                                {{ __('Permanently delete this subscription (cannot be undone)') }}</p>
                        </div>
