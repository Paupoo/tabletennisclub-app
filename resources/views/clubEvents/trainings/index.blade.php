                    ...
                    <div class="text-center py-8 sm:py-12 px-4">
                        <div class="mx-auto w-16 h-16 sm:w-24 sm:h-24 bg-gray-100 rounded-full flex items-center justify-center mb-3 sm:mb-4">
                            <svg class="w-8 h-8 sm:w-12 sm:h-12 text-gray-400" fill="none" stroke="currentColor"
                                 viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 9a2 2 0 00-2 2v2a2 2 0 002 2m0 0h14m-14 0a2 2 0 002 2v2a2 2 0 01-2 2M7 7V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                            </svg>
                        </div>
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end space-x-2">
                                            @if($training->trainees()->where('user_id', Auth()->id())->exists())
                                                ...
                                                <form action="{{ route('trainings.unregister', $training->id) }}"
                                            ...
                                            @else
                                                ...
                                                @if($training->room->capacity_for_trainings > $training->trainees()->count())
                                                    {{-- Subscription --}}
                                                    <form action="{{ route('trainings.register', $training->id) }}"
                                                          method="GET" class="inline">
                                                        @csrf
                                                        <button type="submit"
