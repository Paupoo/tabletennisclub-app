        ...
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                ...
                @if($article->is_public && $article->status->value === 'published')
                    <a href="{{ route('public.clubPosts.show', $article) }}"
                       target="_blank"
                ...
                <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border-b border-gray-100 pb-2">
                            ...
                            <p class="text-sm sm:text-base text-gray-800 mt-1">{{ str_word_count(strip_tags($article->content)) }}
                                mots</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex-shrink-0 h-12 w-12">
                            <div class="h-12 w-12 rounded-full bg-club-blue flex items-center justify-center">
                                <span class="text-sm font-medium text-white">
                                    {{ strtoupper(show.blade.phpsubstr($article->user->first_name, 0, 1) . substr($article->user->last_name, 0, 1)) }}
                                </span>
                            </div>
                        </div>
                        <div>
