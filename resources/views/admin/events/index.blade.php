                ...
                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select name="status"
                            ...
                            @foreach (\App\Enums\EventStatusEnum::values() as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select name="category"
                            class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-club-blue focus:border-club-blue">
                            <option value="">{{ __('All') }}</option>
                            @foreach (\App\Enums\EventTypeEnum::values() as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <button type="submit"
                        class="bg-club-blue hover:bg-club-blue-light text-white px-4 py-2 rounded-lg text-sm font-medium">
                        Filtrer
                    </button>
                </div>
            </form>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($events as $event)
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <div
                                                class="h-10 w-10 rounded-full bg-club-blue flex items-center justify-center text-lg">
                                                {{ $event->icon }}
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="{{ $event->getCategoryBadgeClasses() }} px-2 py-1 rounded-full text-xs font-medium">
                                        {{ $event->category_label }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="{{ $event->getStatusBadgeClasses() }} px-2 py-1 rounded-full text-xs font-medium">
                                        {{ $event->status_label }}
                                    </span>
                                </td>
                                ...
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <div class="text-center">
                                        <svg class="mx-auto h-12 w-12 text-gray-400" fill="none"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M8 7V3a2 2 0 012-2h8a2 2 0 012 2v4m-6 12h8a2 2 0 002-2V7a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2z">
                                            </path>
                                        </svg>
                                        <h3 class="mt-2 text-sm font-medium text-gray-900">Aucun événement trouvé</h3>
                                        <p class="mt-1 text-sm text-gray-500">Commencez par créer un nouvel événement.
                                        </p>
                                        <div class="mt-6">
                                            <a href="{{ route('admin.events.create') }}"
                        ...
                        <div class="border-b border-gray-200 p-4 hover:bg-gray-50 transition-colors duration-200">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="flex flex-col space-y-1">
                                    <span
                                        class="{{ $event->getStatusBadgeClasses() }} px-2 py-1 rounded-full text-xs font-medium text-center">
                                        {{ $event->status_label }}
                                    </span>
                                    <span
                                        class="{{ $event->getCategoryBadgeClasses() }} px-2 py-1 rounded-full text-xs font-medium text-center">
                                        {{ $event->category_label }}
                                    </span>
                                </div>
                            </div>
