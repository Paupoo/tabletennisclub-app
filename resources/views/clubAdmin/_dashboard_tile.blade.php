@php
    $colorMap = [
        ...
        'neutral'   => ['border' => 'hover:border-primary',      'icon_bg' => 'bg-base-200',      'icon_text' => 'text-base-content/50'],
        ...
        'gray'      => ['border' => 'hover:border-primary',      'icon_bg' => 'bg-gray-100',      'icon_text' => 'text-gray-500'],
    ];
