    ...
    <x-admin-block>
        ...
        <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3" x-data="{ emailTemplateOpen: false, showDeleteModal: false }">
                ...
                @can('sendEmail', $user)
                    <button @click="emailTemplateOpen = !emailTemplateOpen"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <!-- Souscriptions -->
                <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6" x-data="{ subscriptionModal: false }"">
                    ...
                    @if ($subscription)
                        <div class="space-y-4">
                            <div class="border rounded-lg p-4 hover:shadow-md transition-shadow">
                                <div class="flex items-center justify-between mb-3" x-data="{ trainingModal: false }">
                                    <div>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    @if ($trainingPacks->count() > 0)
                                                        <div class="flex justify-end mt-6 space-x-3">
                                                            <button type="button" @click="trainingModal = false"
                    ...
                    <div class="flex items-center justify-center min-h-screen px-4">
                        <div x-show="showDeleteModal2" x-transition:enter="transition ease-out duration-300"
                            ...
                            <form method="post" action="{{ route('profile.destroy') }}">
                                ...
                                <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                                    <button type="button" @click="showDeleteModal2 = false"
                                        class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg font-medium transition-colors text-sm">
                                        {{ __('Cancel') }}
                                    </button>
                                    <button type="submit"
