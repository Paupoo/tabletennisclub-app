            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if(session()->has('success'))
                        <div class="mt-6 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded-r-md"
                            role="alert">
                            <div class="flex">
                    ...
                    @elseif(session()->has('error'))
                        <div class="mt-6 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-r-md" role="alert">
                            <div class="flex">
                                <div class="flex-shrink-0">
