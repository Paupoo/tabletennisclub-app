...
<?php $component = Mary\View\Components\Header::resolve(['title' => __('Bank Transactions'),'subtitle' => __('Imported bank statements'),'separator' => true,'progressIndicator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Search counterparty, reference...')),'wire:model.live.debounce.300ms' => 'search','class' => 'border-none bg-base-200 w-64']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary btn-sm','wire:click' => '$set(\'importModal\', true)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'border border-base-200 bg-base-100']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

            <div class="flex items-center justify-between">
                <div>
                    <div class="text-xs font-bold uppercase tracking-widest opacity-50"><?php echo e(__('Total')); ?></div>
                    <div class="text-2xl font-black mt-1"><?php echo e($this->stats['total']); ?></div>
                    <div class="text-xs opacity-60 mt-0.5"><?php echo e(__('transactions imported')); ?></div>
                </div>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-10 h-10 opacity-20']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-xs font-bold uppercase tracking-widest opacity-50"><?php echo e(__('Reconciled')); ?></div>
                    <div class="text-2xl font-black mt-1"><?php echo e($this->stats['reconciled']); ?></div>
                    <div class="text-xs opacity-60 mt-0.5"><?php echo e(__('matched to a payment')); ?></div>
                </div>
                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-xs font-bold uppercase tracking-widest opacity-50"><?php echo e(__('Unreconciled')); ?></div>
                    <div class="text-2xl font-black mt-1"><?php echo e($this->stats['unreconciled']); ?></div>
                    <div class="text-xs opacity-60 mt-0.5"><?php echo e(__('incoming, no match yet')); ?></div>
                </div>
                <?php if (isset($component)) { $__componentOriginalce0070e6ae017cca68172d0230e44821 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce0070e6ae017cca68172d0230e44821 = $attributes; } ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $headers,'rows' => $transactions,'sortBy' => $sortBy] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_date', function($transaction) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <span class="text-sm tabular-nums"><?php echo e(\Carbon\Carbon::parse($transaction->date)->format('d/m/Y')); ?></span>
            <?php }); ?>

            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_counterparty_name', function($transaction) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <div>
                <div class="font-medium text-sm"><?php echo e($transaction->counterparty_name ?? '—'); ?></div>
                ...
                <div class="font-mono text-xs opacity-50"><?php echo e($transaction->counterparty_bank_account); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <?php }); ?>

            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_structured_reference', function($transaction) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            ...
            <span class="font-mono text-xs text-primary"><?php echo e($transaction->structured_reference); ?></span>
            <?php elseif($transaction->free_reference): ?>
            <span class="text-xs opacity-60 italic truncate max-w-xs block"><?php echo e($transaction->free_reference); ?></span>
            <?php else: ?>
            <span class="opacity-30">—</span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php }); ?>

            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_amount', function($transaction) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            ...
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_status', function($transaction) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transaction->payment): ?>
...
<?php $component = Mary\View\Components\Badge::resolve(['value' => ''.e(__('Reconciled')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'badge-success badge-sm badge-soft']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginal4f015fb6508e425790bdb8f79792e6ed = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4f015fb6508e425790bdb8f79792e6ed = $attributes; } ?>
<?php $component = Mary\View\Components\Badge::resolve(['value' => ''.e(__('Outgoing')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Badge::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'badge-error badge-sm badge-soft']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Badge::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'badge-warning badge-sm badge-soft']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transactions->total() === 0): ?>
...
<?php unset($__componentOriginalce0070e6ae017cca68172d0230e44821); ?>
<?php endif; ?>
            <p class="text-sm italic"><?php echo e(__('No transactions yet. Import a bank statement to get started.')); ?></p>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH /home/aurelien/Documents/01 Projets/03-tabletennisclub-app/storage/framework/views/test_15/livewire/views/1ddd6b12.blade.php ENDPATH**/ ?>