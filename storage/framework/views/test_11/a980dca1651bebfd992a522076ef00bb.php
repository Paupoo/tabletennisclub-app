...
<?php endif; ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(["gap-4 grid", "sm:flex sm:gap-6" => $inline]); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <label>
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(["flex items-center gap-3 cursor-pointer", "!items-start" => data_get($option, $optionHint)]); ?>">
                            <input
                                type="radio"
                                ...
                                <?php echo e($attributes->class(["radio"])); ?>
                            ...
                            <div>
                                ...
                                <div class="text-sm font-medium">
                                    <?php echo e(data_get($option, $optionLabel)); ?>

                                </div>

                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(data_get($option, $optionHint)): ?>
                                    <div class="<?php echo e($hintClass); ?> mt-1" x-classes="fieldset-label">
                                        <?php echo e(data_get($option, $optionHint)); ?>
...
</div><?php /**PATH /home/aurelien/Documents/01 Projets/03-tabletennisclub-app/storage/framework/views/test_11/340c7ec5caf93b6e95751cc61b9a41d5.blade.php ENDPATH**/ ?>