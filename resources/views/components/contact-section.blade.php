            ...
            <div class="animate-on-scroll">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="flex-shrink-0 w-12 h-12 bg-club-blue rounded-lg flex items-center justify-center">
                    ...
                    <div class="flex items-start">
                        <div class="flex-shrink-0 w-12 h-12 bg-club-yellow rounded-lg flex items-center justify-center">
                    ...
                    ">
                        ...
                        <div class="mb-6">
                            <label class="flex items-start">
                                <input type="checkbox" required class="mt-1 mr-3 h-4 w-4 text-club-blue focus:ring-club-blue border-gray-300 rounded">
