                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <div>
                                                <a href="{{ route('tournaments.toggleHasPaid', [$tournament, $user]) }}">
                                                    @if(!$user->pivot->has_paid)
                                                    <!-- Marquer comme payé -->
                                                    <button class="inline-flex items-center p-2 border border-transparent rounded-full text-white bg-green-600 hover:bg-green-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-green-500" title="Marquer comme payé">
                                                    ...
                                                    <button class="inline-flex items-center p-2 border border-transparent rounded-full text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500" title="Marquer comme impayé">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                ...
                                                <!-- Désinscrire -->
                                                <a href="{{ route('tournament.unregister', [$tournament, $user]) }}"
                                                    <button class="inline-flex items-center p-2 border border-transparent rounded-full text-white bg-red-600 hover:bg-red-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-red-500" title="Désinscrire">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <a href="{{ route('tournament.register', [$tournament, $user]) }}"
                                                class="inline-flex items-center px-3 py-1 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                                Inscrire
                                            </a>
                                        </td>
                                    </tr>
