        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                ...
                <div class="w-full p-6 text-gray-900 dark:text-gray-100 lg:w-1/2">
                    ...
                    <form action="{{ route('rooms.store') }}" method="POST" class="mt-6 space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="street" name="street" type="text" class="block w-full mt-1"
                                :value="old('street')" required autofocus autocomplete="street"></x-text-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="city_code" name="city_code" type="text" class="block w-full mt-1"
                                :value="old('city_code')" required autofocus autocomplete="city_code"></x-text-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="city_name" name="city_name" type="text" class="block w-full mt-1"
                                :value="old('city_name')" required autofocus autocomplete="city_name"></x-text-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="building_name" name="building_name" type="text"
                                class="block w-full mt-1" :value="old('building_name')" required autofocus
                        ...
                        <div>
                            ...
                            <x-textarea-input id="access_description" name="access_description" type="text"
                                ...
                                autofocus>{{ old('access_description', 'Describe here the new role.') }}</x-textarea-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="capacity_trainings" name="capacity_trainings" type="text"
                                class="block w-full mt-1" :value="old('capacity_trainings')" required autofocus
                                autocomplete="capacity_trainings"></x-text-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="capacity_matches" name="capacity_matches" type="text"
                                class="block w-full mt-1" :value="old('capacity_matches')" required autofocus
                                autocomplete="capacity_matches"></x-text-input>
                            <x-input-error class="mt-2" :messages="$errors->get('capacity_matches')" />
                        </div>

                        <div>
                            <x-primary-button>{{ __('Create new room') }}</x-primary-button>
                        </div>
