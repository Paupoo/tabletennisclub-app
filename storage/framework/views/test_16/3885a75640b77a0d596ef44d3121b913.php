...
<div class="w-full max-w-sm mx-auto space-y-4"
    wire:poll.5s
    x-data="{ confirmOpen: false, submitted: <?php echo e($submitted ? 'true' : 'false'); ?> }">
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-14 h-14 mx-auto text-success']); ?>
...
<?php endif; ?>
            <h2 class="text-lg font-bold text-success"><?php echo e(__('Score submitted!')); ?></h2>
            <p class="text-sm text-base-content/60"><?php echo e(__('The result has been sent to the tournament organisation. Thank you!')); ?></p>
        </div>
    </div>
    ...
    <div x-show="!submitted" class="space-y-4">
        ...
        <div class="bg-base-100 rounded-2xl shadow p-5">
            <div class="text-[10px] font-bold uppercase tracking-widest opacity-40 mb-3 text-center">
                <?php echo e($match->pool?->name ?? __('Bracket')); ?> · <?php echo e(__('Table')); ?> <?php echo e($table->name); ?>
            ...
            <div class="flex justify-between items-center gap-4">
                <div class="flex-1 text-center">
                    <div class="font-black text-sm uppercase leading-tight wrap-break-word hyphens-auto
                        <?php echo e($matchFinished && $p1Sets >= $tournament->sets_to_win ? 'text-success' : ''); ?>">
                        <?php echo e($match->player1?->full_name ?? '—'); ?>

                    </div>
                    <div class="text-4xl font-extrabold mt-1
                        <?php echo e($matchFinished && $p1Sets >= $tournament->sets_to_win ? 'text-success' : 'text-primary'); ?>">
                        <?php echo e($p1Sets); ?>
                ...
                <div class="flex-1 text-center">
                    <div class="font-black text-sm uppercase leading-tight wrap-break-word hyphens-auto
                        <?php echo e($matchFinished && $p2Sets >= $tournament->sets_to_win ? 'text-success' : ''); ?>">
                        <?php echo e($match->player2?->full_name ?? '—'); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tournament->has_handicap_points && ($hp1 > 0 || $hp2 > 0)): ?>
            <div class="bg-base-100 rounded-2xl shadow px-5 py-4">
                ...
                <div class="flex justify-between items-center gap-4">
                    <div class="flex-1 text-center">
                        <div class="text-[10px] font-bold opacity-60 truncate"><?php echo e($match->player1?->full_name ?? '—'); ?></div>
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-3xl font-extrabold leading-none mt-1', 'text-warning' => $hp1 > 0, 'text-base-content/30' => $hp1 === 0]); ?>">
                            +<?php echo e($hp1); ?>
                    ...
                    <div class="flex-1 text-center">
                        <div class="text-[10px] font-bold opacity-60 truncate"><?php echo e($match->player2?->full_name ?? '—'); ?></div>
                        <div class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-3xl font-extrabold leading-none mt-1', 'text-warning' => $hp2 > 0, 'text-base-content/30' => $hp2 === 0]); ?>">
                            +<?php echo e($hp2); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < $maxSets; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                    ...
                    <div class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                        ...
                        <span class="text-base font-black leading-none"><?php echo e($i + 1); ?></span>
                    </div>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'setScores.'.e($i).'.p1','type' => 'number','min' => ''.e($hp1).'','max' => '30','placeholder' => ''.e($hp1).'','class' => 'input-lg text-center font-mono font-black text-2xl flex-1 p-1']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'setScores.'.e($i).'.p2','type' => 'number','min' => ''.e($hp2).'','max' => '30','placeholder' => ''.e($hp2).'','class' => 'input-lg text-center font-mono font-black text-2xl flex-1 p-1']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php unset($__componentOriginalce0070e6ae017cca68172d0230e44821); ?>
<?php endif; ?>
                    <?php echo e(__('Submit score')); ?>

                </button>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSets && ! $matchFinished): ?>
                <button
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($winner): ?>
                    <div>
                        ...
                        <p class="text-xl font-black"><?php echo e($winner->full_name); ?></p>
                        <p class="text-4xl font-extrabold text-success mt-1"><?php echo e($p1Sets); ?> — <?php echo e($p2Sets); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH /home/aurelien/Documents/01 Projets/03-tabletennisclub-app/resources/views/pages/club-events/tournaments/⚡table-score-entry.blade.php ENDPATH**/ ?>